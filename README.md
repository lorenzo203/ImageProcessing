...
The quest represented the first NLA challenge of the semester, hence the main program is denoted as `challenge1.cpp` as well as the executable generated by the Makefile, which is called `challenge1`.
